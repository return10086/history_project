...
****************************************************************************/
uint8_t  GUI_PutChar(uint32_t x, uint32_t y, uint8_t ch)
{  uint8_t   font_dat;
   uint8_t   i, j;
   TCOLOR  bakc;
...
****************************************************************************/
void  GUI_PutString(uint32_t x, uint32_t y, char *str)
{  while(1)
   {  if( (*str)=='\0' ) break;
...
* 说明：操作失败原因是指定地址超出有效范围。
****************************************************************************/
void  GUI_PutNoStr(uint32_t x, uint32_t y, char *str, uint8_t no)
{  if(no==0) return;
   for(; no>0; no--)
   {  if( (*str)=='\0' ) break;
      if( GUI_PutChar(x, y, *str++)==0 ) break;
