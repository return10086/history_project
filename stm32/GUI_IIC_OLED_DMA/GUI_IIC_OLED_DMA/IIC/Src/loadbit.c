...
****************************************************************************/
uint8_t  GUI_LoadLine(uint32_t x, uint32_t y, uint8_t *dat, uint32_t no)
{  uint8_t   bit_dat;
   uint8_t   i;
   TCOLOR  bakc;
...
* 说明：操作失败原因是指定地址超出有效范围。
****************************************************************************/
void  GUI_LoadPic(uint32_t x, uint32_t y, uint8_t *dat, uint32_t hno, uint32_t lno)
{  uint32_t  i;
...
* 说明：操作失败原因是指定地址超出有效范围。
****************************************************************************/
void  GUI_LoadPic1(uint32_t x, uint32_t y, uint8_t *dat, uint32_t hno, uint32_t lno)
{  uint32_t  i;
...
* 说明：操作失败原因是指定地址超出有效范围。
****************************************************************************/
void  GUI_PutHZ(uint32_t x, uint32_t y, uint8_t *dat, uint8_t hno, uint8_t lno)
{  uint8_t  i;
