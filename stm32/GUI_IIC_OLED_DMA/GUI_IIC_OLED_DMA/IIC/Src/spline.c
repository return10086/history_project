...
void set(void)
{
	setPointXY(&empty_point[0],0,32);
	setPointXY(&empty_point[1],32,12);
	setPointXY(&empty_point[2],64,32);
	setPointXY(&empty_point[3],96,52);
	setPointXY(&empty_point[4],128,32);
	//setPointXY(&empty_point[5],50,0);
}
