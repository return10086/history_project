...
****************************************************************************/
uint8_t  GUI_MMenuDraw(MMENU *men)
{  WINDOWS  *mwin;
   uint8_t  i;
   uint8_t  xx;
...
* 出口参数：无
****************************************************************************/
void  GUI_MMenuSelect(MMENU *men, uint8_t no)
{  WINDOWS  *mwin;
   uint8_t  xx;
...
* 出口参数：无
****************************************************************************/
void  GUI_MMenuNSelect(MMENU *men, uint8_t no)
{  WINDOWS  *mwin;
   uint8_t  xx;
...
* 出口参数：返回0表示操作失败，返回1表示操作成功
****************************************************************************/
uint8_t  GUI_SMenuDraw(SMENU *men)
{  WINDOWS  *mwin;
   uint32_t   xx, yy;
   uint8_t    i;
...
* 出口参数：无
****************************************************************************/
void  GUI_SMenuSelect(SMENU *men, uint8_t old_no, uint8_t new_no)
{  WINDOWS  *mwin;
   uint8_t  xx, yy;
...
* 出口参数：返回0表示操作失败，返回1表示操作成功
****************************************************************************/
uint8_t  GUI_SMenuHide(SMENU *men)
{  WINDOWS  *mwin;
   uint8_t    xx, yy;
...
* 出口参数：无
****************************************************************************/
void  GUI_Button49x14(uint32_t x, uint32_t y, uint8_t *dat)
{  GUI_LoadPic(x, y, (uint8_t *)dat, 49, 14);
}
...
* 出口参数：无
****************************************************************************/
void  GUI_Button_OK(uint32_t x, uint32_t y)
{  GUI_LoadPic(x, y, (uint8_t *) button_ok, 49, 14);
}
...
* 出口参数：无
****************************************************************************/
void  GUI_Button_OK1(uint32_t x, uint32_t y)
{  GUI_LoadPic(x, y, (uint8_t *) button_ok1, 49, 14);
}
...
* 出口参数：无
****************************************************************************/
void  GUI_Button_Cancle(uint32_t x, uint32_t y)
{  GUI_LoadPic(x, y, (uint8_t *) button_cancle, 49, 14);
}
...
* 出口参数：无
****************************************************************************/
void  GUI_Button_Cancle1(uint32_t x, uint32_t y)
{  GUI_LoadPic(x, y, (uint8_t *) button_cancle1, 49, 14);
}
...
* 出口参数：返回0表示操作失败，返回1表示操作成功
****************************************************************************/
uint8_t  GUI_MenuIcoDraw(MENUICO *ico)
{  
   /* 参数过滤 */
   if( ( (ico->x)<5 ) || ( (ico->x)>(GUI_LCM_XMAX-37 ) ) ) return(0);	// 显示起始地址判断
   if( ( (ico->icodat)==NULL ) || ( (ico->title)==NULL ) ) return(0);	// 显示数据内容判断
   
   GUI_LoadPic(ico->x, ico->y, (uint8_t *) ico->icodat, 32, 32);			// 显示ICO图
   GUI_HLine(ico->x-5, ico->y+32, ico->x+37, back_color);				// 显示一空行
   if( (ico->state)==0 )
   {  GUI_LoadPic(ico->x-5, ico->y+33, (uint8_t *) ico->title, 42, 13);
   }
   else
   {  GUI_LoadPic1(ico->x-5, ico->y+33, (uint8_t *) ico->title, 42, 13);
   }
